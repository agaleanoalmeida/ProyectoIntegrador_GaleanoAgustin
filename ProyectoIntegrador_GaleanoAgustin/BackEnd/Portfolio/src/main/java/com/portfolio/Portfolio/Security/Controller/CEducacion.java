...
import com.portfolio.Portfolio.Security.Dto.DtoEducacion;
import com.portfolio.Portfolio.Security.Entity.Educacion;
import com.portfolio.Portfolio.Security.Service.SEducacion;
...
public class CEducacion {
    ...
    return new ResponseEntity(new Mensaje("Ese nombre ya "), HttpStatus.BAD_REQUEST);
    }
